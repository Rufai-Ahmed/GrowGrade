...
import img from "../Assets/teachmint-logo-dark.svg"
const Header = () => {
    return (
        <div>
            <div className="w-full h-[80px]  flex items-center justify-center
                ...
                <div className="w-[70%] h-[100%] flex items-center justify-between">
                    ...
                    <div className="flex flex-row gap-[20px]">
                        <button className="w-[80px] h-[45px] bg-white border-[1px] border-solid border-blue-600
                        rounded-lg text-blue-600 font-bold text-[15px]
                        ">
                            Login
                        </button>
                        <button className="w-[130px] h-[45px] bg-blue-500 border-[1px] border-solid border-blue-600
